...
mod twitter_oracle {
    ...
    impl SubmittableOracle for TwitterOracle {
        ...
        fn attest(&self, url: String) -> core::result::Result<attestation::Attestation, Vec<u8>> {
            ...
            // Fetch: curl "https://api.twitter.com/2/tweets?ids=1426724855672541191" -H "Authorization: Bearer $BEARER_TOKEN"
            ...
            // ink_env::debug_println!("Status code: {}", response.status_code);
